...
public:
	...
	BwtMapper(BwtIndexer& BwtIndex, const std::string & Fa_List, const std::string & Prefix, const std::string & RefPath, const pe_opt_t* popt, const gap_opt_t * opt);
	...
	bwa_seq_t* bwa_read_seq_with_hash(BwtIndexer& BwtIndex, bwa_seqio_t *bs, int n_needed, int *n, int mode, int trim_qual, double frac);
	...
	/*bool Skip(BwtIndexer& BwtIndex, int mode, const char* seq1, const char* qual1, const char* seq2 = 0, const char* qual2 = 0, int len = 0, double frac = 1.);*/
