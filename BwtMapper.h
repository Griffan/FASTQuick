...
class BwtMapper
  ...
  public:
    ...
    bool SingleEndMapper(BwtIndexer& BwtIndex,const char *fn_fa, const std::string & VcfPath, const gap_opt_t * opt);
    bool PairEndMapper(BwtIndexer& BwtIndex,const char *fn_fa1,const char * fn_fa2, const std::string & VcfPath, const  pe_opt_t *popt,const gap_opt_t* opt);
