...
public:
	...
	BwtMapper();
	BwtMapper(BwtIndexer& BwtIndex,const string & Fastq_1, const string & Fastq_2, const string & VcfPath, const pe_opt_t* popt, const gap_opt_t * opt );
	...
	bool SingleEndMapper(BwtIndexer& BwtIndex,const char *fn_fa, const string & VcfPath, const gap_opt_t * opt);
	bool PairEndMapper(BwtIndexer& BwtIndex,const char *fn_fa1,const char * fn_fa2, const string & VcfPath, const  pe_opt_t *popt,const gap_opt_t* opt);
	bool IsFP(const string &seq, const string &qual, const char * );
	virtual ~BwtMapper();
